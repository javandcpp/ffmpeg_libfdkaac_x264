package app.mobile.anative.com.openglesforandroid.helper;

import android.util.Log;

import app.mobile.anative.com.openglesforandroid.utils.Logger;
...
public class ShaderHelper {
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (programObjectId == 0) {
            Logger.print(TAG, "不能新建一个 program");
            return 0;
        }
        ...
        if (linkStatus[0] == 0) {
            ...
            Logger.print(TAG, "连接 program 失败!.");
