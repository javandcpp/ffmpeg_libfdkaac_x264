...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a --enable-pic --enable-gpl --enable-nonfree --enable-cross-compile --cross-prefix=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --sysroot=/Applications/android-ndk-r13/platforms/android-14/arch-arm --target-os=android --arch=arm --cpu=armv7-a --enable-neon --enable-gpl --enable-shared --enable-cross-compile --enable-neon --disable-shared --enable-static --enable-version3 --enable-pthreads --enable-small --disable-vda --disable-iconv --enable-encoders --enable-libx264 --enable-neon --enable-yasm --enable-libfdk_aac --enable-encoder=libx264 --enable-encoder=libfdk_aac --enable-encoder=mjpeg --enable-encoder=png --enable-nonfree --disable-muxers --enable-muxer=adts --enable-muxer=h264 --enable-muxer=mp4 --enable-muxer=flv --enable-muxer=pcm_s16le --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-decoders --enable-demuxers --enable-parsers --enable-protocols --enable-zlib --enable-avfilter --disable-outdevs --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-ffserver --disable-debug --enable-postproc --enable-avdevice --disable-symver --disable-stripping --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-zlib --disable-debug --extra-cflags='-DANDROID -I/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a/include' --extra-ldflags='-L/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a/lib -lx264 -lfdk-aac -Wl,-dynamic-linker=/system/bin/linker -lc -lm -llog'
prefix=/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a
...
CXX=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/android-ndk-r13/platforms/android-14/arch-arm -isysroot /Applications/android-ndk-r13/platforms/android-14/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -DANDROID -I/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -DANDROID -I/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a/include -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/Applications/android-ndk-r13/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264_lame/jni/ffmpeg-3.2.5/../out/armeabi-v7a/lib -lx264 -lfdk-aac -Wl,-dynamic-linker=/system/bin/linker -lc -lm -llog  --sysroot=/Applications/android-ndk-r13/platforms/android-14/arch-arm -isysroot /Applications/android-ndk-r13/platforms/android-14/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lfdk-aac -lm -pthread 
